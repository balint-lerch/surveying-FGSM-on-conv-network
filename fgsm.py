...
#FGSM method. Perturbating the original image with epsilon * sin of the gradient loss function
...
plt.figure(figsize=(8, 3))
plt.subplot(1, 2, 1)
plot_image(0, preds[0], test_labels, x_adv)
plt.subplot(1, 2, 2)
plot_value_array(0, preds[0], test_labels)
plt.show()

plt.figure(figsize=(8, 3))
plt.subplot(1, 2, 1)
plot_image(15, predictions[15], test_labels, test_images)
plt.subplot(1, 2, 2)
plot_value_array(15, predictions[15], test_labels)
plt.show()

plt.figure(figsize=(8, 3))
plt.subplot(1, 2, 1)
plot_image(15, preds[15], test_labels, x_adv)
plt.subplot(1, 2, 2)
plot_value_array(15, preds[15], test_labels)
plt.show()
